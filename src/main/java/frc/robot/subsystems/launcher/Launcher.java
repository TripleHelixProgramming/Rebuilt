...
public class Launcher extends SubsystemBase {
  ...
  public void periodic() {
    long t0 = Constants.FeatureFlags.profilingEnabled ? System.nanoTime() : 0;

    turretIO.updateInputs(turretInputs);
    flywheelIO.updateInputs(flywheelInputs);
    hoodIO.updateInputs(hoodInputs);
    long t1 = Constants.FeatureFlags.profilingEnabled ? System.nanoTime() : 0;

    Logger.processInputs("Turret", turretInputs);
    Logger.processInputs("Flywheel", flywheelInputs);
    Logger.processInputs("Hood", hoodInputs);
    long t2 = Constants.FeatureFlags.profilingEnabled ? System.nanoTime() : 0;
    ...
    long t3 = Constants.FeatureFlags.profilingEnabled ? System.nanoTime() : 0;
    ...
    long t4 = Constants.FeatureFlags.profilingEnabled ? System.nanoTime() : 0;

    // Profiling output
    if (Constants.FeatureFlags.profilingEnabled) {
  ...
  public void aim(Translation3d target) {
    long aimStart = Constants.FeatureFlags.profilingEnabled ? System.nanoTime() : 0;
    ...
    hasCachedAimData = true;
    long t5 = Constants.FeatureFlags.profilingEnabled ? System.nanoTime() : 0;
