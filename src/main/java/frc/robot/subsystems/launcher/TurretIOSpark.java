...
public class TurretIOSpark implements TurretIO {
  ...
  // Motion profile to limit turret motion (position profile in radians)
  ...
  public void setPosition(Rotation2d rotation, AngularVelocity angularVelocity) {
    ...
    setpoint =
        MathUtil.clamp(
            ...
            Math.PI + rangeOfMotion.div(2).in(Radians));
    // Build motion profile between current position and goal to limit velocity/accel
