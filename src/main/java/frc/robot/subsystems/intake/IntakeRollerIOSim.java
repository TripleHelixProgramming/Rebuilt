...
public class IntakeRollerIOSim implements IntakeRollerIO {
    ...
    public IntakeRollerIOSim() {
        ...
        intakeRollerSim = new DCMotorSim(LinearSystemId.createDCMotorSystem(gearbox, 0.004, motorReduction), gearbox);
    ...
    public void updateInputs(IntakeIOInputs inputs) {
        ...
        inputs.velocityMetersPerSec = intakeVelocity.getValueAsDouble() * rollerRadius.in(Meters) * (2 * Math.PI);
    }
