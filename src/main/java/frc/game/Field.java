...
public class Field {
  ...
  private static final Distance neutralZone_x_len = centerField_x_pos.minus(hub_x_centerPos.plus(hub_x_len)).times(2);
  ...
  private static final Pose2d blueHubCenter = new Pose2d(new Translation2d(hub_x_centerPos, centerField_y_pos), Rotation2d.kZero);
  private static final Pose2d redHubCenter = new Pose2d(new Translation2d(centerField_x_pos.times(2).minus(hub_x_centerPos), centerField_y_pos), Rotation2d.kZero);
  ...
  enum Region {
    ...
    RedLeftTrench(new Rectangle2d(new Translation2d(field_x_len.minus(hub_x_centerPos).minus(hub_x_len.div(2)), Inches.of(0)), new Translation2d(field_x_len.minus(hub_x_centerPos).plus(hub_x_len.div(2)), trench_y_len))),
    RedRightTrench(new Rectangle2d(new Translation2d(field_x_len.minus(hub_x_centerPos).minus(hub_x_len.div(2)), field_y_len.minus(trench_y_len)), new Translation2d(field_x_len.minus(hub_x_centerPos).plus(hub_x_len.div(2)), field_y_len))),
    BlueLeftTrench(new Rectangle2d(new Translation2d(hub_x_centerPos.minus(hub_x_len.div(2)), field_y_len.minus(trench_y_len)), new Translation2d(hub_x_centerPos.plus(hub_x_len.div(2)), field_y_len))),
    BlueRightTrench(new Rectangle2d(new Translation2d(hub_x_centerPos.minus(hub_x_len.div(2)), Inches.of(0)), new Translation2d(hub_x_centerPos.plus(hub_x_len.div(2)), trench_y_len))),
    RedLeftBump(new Rectangle2d(new Translation2d(field_x_len.minus(hub_x_centerPos).minus(hub_x_len.div(2)), centerField_y_pos.minus(hub_y_len.div(2)).minus(bump_y_len)), new Translation2d(field_x_len.minus(hub_x_centerPos).plus(hub_x_len.div(2)), centerField_y_pos.minus(hub_y_len.div(2))))),
    RedRightBump(new Rectangle2d(new Translation2d(field_x_len.minus(hub_x_centerPos).minus(hub_x_len.div(2)), centerField_y_pos.plus(hub_y_len.div(2))), new Translation2d(field_x_len.minus(hub_x_centerPos).plus(hub_x_len.div(2)), centerField_y_pos.plus(hub_y_len.div(2)).plus(bump_y_len)))),
    BlueLeftBump(new Rectangle2d(new Translation2d(hub_x_centerPos.minus(hub_x_len.div(2)), centerField_y_pos.plus(hub_y_len.div(2))), new Translation2d(hub_x_centerPos.plus(hub_x_len.div(2)), centerField_y_pos.plus(hub_y_len.div(2)).plus(bump_y_len)))),
    BlueRightBump(new Rectangle2d(new Translation2d(hub_x_centerPos.minus(hub_x_len.div(2)), centerField_y_pos.minus(hub_y_len.div(2)).minus(bump_y_len)), new Translation2d(hub_x_centerPos.plus(hub_x_len.div(2)), centerField_y_pos.minus(hub_y_len.div(2))))),
    BlueDepot(new Rectangle2d(new Translation2d(Inches.of(0), depot_y_centerPos.minus(depot_y_len.div(2))), new Translation2d(depot_x_len, depot_y_centerPos.plus(depot_y_len.div(2))))),
